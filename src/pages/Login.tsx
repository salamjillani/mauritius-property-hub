...
const Login = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Logging in with:", { ...loginData, accountType });
    // We'd typically handle the auth logic here
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-center">
              Access your PropertyMauritius account
            </CardDescription>
          </CardHeader>
          
          <Tabs 
            value={accountType} 
            onValueChange={(v) => setAccountType(v as "individual" | "professional")}
            className="w-full"
          >
